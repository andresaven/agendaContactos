...
public class VentanaEditar extends JDialog {
    ...
    public VentanaEditar() {            	
        ...
        ImageIcon iconoEdit = new ImageIcon("notebook.png");
	    setIconImage(iconoEdit.getImage());
        setBounds(300,200,350,400);
        inicializarVariables();
    }
    
    //Método para inicializar todas las variables declaradas en la clase 
    ...
    private void inicializarVariables() {
        ...
        etiquetaNombre.setFont(new Font("Roboto", Font.ITALIC, 16));
        ...
        etiquetaTelefono.setFont(new Font("Dialog", Font.ITALIC, 16));
